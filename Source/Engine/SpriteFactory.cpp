...
namespace SE
{
	...
	void CSpriteFactory::ReturnSprite(SE::CSprite* aSprite, bool anAlsoDelete)
	{
		auto it = myPool.find(aSprite);
		if (it != myPool.end())
		{
			SE::CSprite* sprite = *it;
			myPool.erase(sprite);
